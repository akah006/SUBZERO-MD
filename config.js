...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "SUBZERO-MD~VWt5YcKTgZ7JRvi2lli1",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "917872324809",  // Owner's WhatsApp number
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "Mr Frank",           // Owner's name
    DEV: process.env.DEV || "917872324809",                     // Developer's contact number
    DEVELOPER_NUMBER: '917872324809@s.whatsapp.net',            // Developer's WhatsApp ID
